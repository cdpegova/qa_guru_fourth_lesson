...
public class Service {
    ...
    private void fillDateOfBorn(){
        Locators.dateOfBorn.click();
        Locators.dateOfBorn.sendKeys(Keys.CONTROL + "a");
        Locators.dateOfBorn.setValue("01.08.2000");
        Locators.dateOfBorn.pressEnter();
    }
